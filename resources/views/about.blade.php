...
@section('title', ' - About VeganKitchen')

@section('content')
    <h4 class="intro">Creating memories, one experience at a time</h4>
    <p>
        Vegan Kitchen Restaurant isn’t just about dining. We’re about creating memorable experiences that our guest will cherish!
